/**
 * @file Prevent using silent option in functions that cause events
 * @author Ilya Volodin
...
module.exports = {
    ...
    create: function(context) {
        ...
        var settings = context.settings || /* c8 ignore next */ {};
        var backbone = [];
        ...
        return {
            ...
            "Identifier": function(node) {
                ...
                var ancestors = context.sourceCode.getAncestors(node);
